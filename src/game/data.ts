...
export const weapons: Weapon[] = [
  ...
  },
  {
    ...
    fireRateMs: 360,
    skillName: "風向反転",
    skillDescription: "長射程の近接斬撃で竜巻の向きをそらし、竜巻/台風に追加ダメージ",
    skillBurstRatio: 0.46,
    skillBurstShots: 3,
    description: "風向を斬って乱流を逸らす長柄ブレード。弾は使わず、間合いに踏み込んだ直接攻撃だけが当たる。",
...
export const characters: Character[] = [
  {
    ...
    accentColor: "#28d9ff",
    description: "気象観測局所属の若きバスター。長く続いた雨の記憶を胸に、湿度系侵害体の観測と制圧に強いこだわりを持つ。",
    flavor: "梅雨を、ゆるさない。",
  },
  {
    id: "saka",
