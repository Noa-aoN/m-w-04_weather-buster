...
const chapters = [
  ...
  },
  {
    eyebrow: "CHAPTER 03",
    title: "ウェザーブレイカー",
    body: "兵器を扱えるのは、気象耐圧スーツに適合した一握りの観測員だけ。彼らは ウェザーブレイカー と呼ばれ、空を晴らすことだけを任務とする。風に流されず、雷に焼かれず、雨に視界を奪われない。それが、彼らがプロである所以だ。",
  },
  {
    eyebrow: "CHAPTER 04",
    title: "ノアと、長い雨",
    body: "若いウェザーブレイカー、ノアの父は、もう何年も止まなかった梅雨に呑まれた。あの日から ノア の照準は梅雨だけを狙う。クリアスカイガンを構える時、彼は決まって短くつぶやく ―― 「梅雨だけは許さない」。彼にとって空を晴らすことは、父を弔うことと同じ意味を持つ。",
  },
  {
    eyebrow: "CHAPTER 05",
    title: "晴天の種子",
    body: "侵害体を倒すと、空に薄く光る粒子が残る。観測局はこれを 晴天の種子 と名付けた。種子を一定数集めれば、地域の空は永続的に元の青さを取り戻す ―― それが、ウェザーバスター計画の最終ゴールだ。今日の青空は、明日の青空のための一歩でしかない。",
  },
  {
    eyebrow: "CHAPTER 06",
    title: "そして、台風が来る",
    body: "豪雨・落雷・竜巻 ―― 三つの脅威を併せ持つ複合型侵害体「台風」が観測された。単独では討伐困難。それでもウェザーブレイカーは出撃する。空が敵になったその日から、誰かは必ず、空を取り戻しに行かねばならない。",
  },
];
